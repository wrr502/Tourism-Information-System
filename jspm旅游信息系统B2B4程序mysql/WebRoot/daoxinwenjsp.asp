...
<%
connstr="DRIVER={SQL Server};Server=.\SQLEXPRESS;UID=sa;PWD=sa123456;DATABASE=jspmlyxxxtB2B4;"
...
<body>
<%
sql="select top 15  * from allgonggao where title like '%旅%' or leibie like '%游%' order by newid()"
