...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt onClick="changeImage()">旅游攻略管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp" target="rightFrame">旅游攻略添加</a></dd>
			<dd><a href="xinwentongzhi_list.jsp" target="rightFrame">旅游攻略查询</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">订单管理<img src="images/left/select_xl01.png"></dt>
			<!--<dd class="first_dd"><a href="xinwentongzhi_add.jsp?lb=旅游攻略" target="rightFrame">旅游攻略添加</a></dd>-->
			<dd><a href="goumaijilu_list.jsp" target="rightFrame">订单查看</a></dd>
		</dl>
	
		<!--<dl class="app">
			<dt onClick="changeImage()">旅游攻略管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp?lb=旅游攻略" target="rightFrame">旅游攻略添加</a></dd>
			<dd><a href="xinwentongzhi_list.jsp?lb=旅游攻略" target="rightFrame">旅游攻略添加</a></dd>
		</dl>
	-->
		<dl class="cloud">
			<dt onClick="changeImage()">旅游景点管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="lvyoujingdian_add.jsp" target="rightFrame">旅游景点添加</a></dd>
			<dd><a href="lvyoujingdian_list.jsp" target="rightFrame">旅游景点查询</a></dd>
		</dl>
		...
		<dl class="statistics">
			...
			<dd><a href="liuyanban_list.jsp" target="rightFrame">留言管理</a></dd>
