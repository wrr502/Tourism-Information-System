...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd"><a href="yonghuzhuce_updt2.jsp" target="rightFrame">个人信息管理</a></dd>
			
		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()"> 我人订单管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="goumaijilu_list2.jsp" target="rightFrame">查看订单</a></dd>
			

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">收藏管理<img src="images/left/select_xl01.png"></dt>
			
			<dd><a href="shoucangjilu_list2.jsp" target="rightFrame">个人收藏查看</a></dd>
		</dl>
